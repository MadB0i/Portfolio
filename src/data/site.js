...
export const SKILLS = [
  {
    ...
    media: '<svg viewBox="0 0 240 64" fill="none" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" class="skill-accent skill-media" aria-hidden="true"><rect class="media-frame" x="1" y="1" width="238" height="62" rx="10"/><text class="media-label" x="16" y="16" fill="currentColor" stroke="none" font-size="7" font-family="monospace">daily_toolchain</text><path class="media-line" d="M16 29h72M16 43h118M16 54h62"/><circle class="media-pulse" cx="211" cy="31" r="7"/><path class="media-line" d="M205 31h12M211 25v12"/><circle class="media-packet" cx="112" cy="43" r="2.5" fill="currentColor" stroke="none"/></svg>',
